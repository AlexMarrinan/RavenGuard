...
{
    /// <summary>
    /// This is a custom OptionListView, and it was made to edit where the optionViewPrefabs would
    /// be instantiated. Due to the variables being private, we were not able to use the original
    /// as a parent.
    /// </summary>
    public class OptionListView : DialogueViewBase
    {
        ...
        public override void RunOptions(DialogueOption[] dialogueOptions, Action<int> onOptionSelected)
        {
            ...
            OptionView CreateNewOptionView()
            {
                ...
                optionView.transform.SetParent(lastLineText.transform.parent, false);
